...
* Fri Aug 10 2018 Michael Stauber <mstauber@solarspeed.net> 1.0.2-7
- Fix in am_network.sh for OpenVZ 7 again. IP of node not pingable.

* Fri Jul 27 2018 Michael Stauber <mstauber@solarspeed.net> 1.0.2-6
- Small fix in /usr/sausalito/swatch/bin/am_network.sh for OpenVZ 7

* Mon May 07 2018 Michael Stauber <mstauber@solarspeed.net> 1.0.2-5
- Small fix in /usr/sausalito/swatch/bin/am_network.sh

* Thu Feb 08 2018 Michael Stauber <mstauber@solarspeed.net> 1.0.2-4
- Small fix in /usr/sausalito/swatch/bin/am_network.sh

* Fri Feb 02 2018 Michael Stauber <mstauber@solarspeed.net> 1.0.2-3
- Modified /usr/sausalito/swatch/bin/am_network.sh for IPv6 support.
