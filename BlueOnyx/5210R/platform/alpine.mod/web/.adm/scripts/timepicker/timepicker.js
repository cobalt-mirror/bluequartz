...
(function($){
	jQuery.fn.timepicker = function(){
		this.each(function(){
			...
			output += '<select id="h_' + i + '" class="h timepicker" name="hour_' + i + '">';
			for(hr in hrs){
			...
			output += '<select id="m_' + i + '" class="m timepicker" name="minute_' + i + '">';
			for(mn in mins){
			...
			output += '<select id="p_' + i + '" class="p timepicker" name="ampm_' + i + '">';
			for(pp in ap){
