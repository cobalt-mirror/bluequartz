...
$net2ftp_settings["email_feedback"] = "admin";
...
//$net2ftp_settings["encryption_string"] = "462E16CB8C3F369BD9F4DBEE0A256F8F14FFB3";
//
// Instead we use the CodeIgniter 'enrcyption_key' as base-alpine randomizes that on
// every update/install of base-alpine:
define('BASEPATH', '/usr/sausalito/ui/chorizo/ci/application');
require_once("/usr/sausalito/ui/chorizo/ci/application/config/config.php");
$net2ftp_settings["encryption_string"] = $config['encryption_key'];
