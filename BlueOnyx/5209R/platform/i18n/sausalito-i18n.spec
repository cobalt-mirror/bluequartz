...
* Thu Nov 20 2014 Michael Stauber <mstauber@solarspeed.net> 0.81.2-0BX01
- Cracklib updated to last version from SVN. Still blows up. Disabled.
- i18n PHP module build disabled, as we now replace it with a PHP class.
