...
# $Id: 40_addGateway.pl Sat 15 Oct 2011 09:09:00 PM EDT mstauber $
...
sub fix_if_up {
    ...
    # Now this is really dirty. If we're on OpenVZ, then a network restart will drop our custum routes. Sure, if we
	...
	# If it exists, check if already has our 'venet0:0' provisions in it:
