...
# $Id: pam_abl_purge.pl, v1.0.0-0 Thu 06 Aug 2009 06:24:22 AM CEST mstauber Exp $
# Copyright 2006-2009 Solarspeed Ltd. All rights reserved.
# Copyright 2009 Team BlueOnyx. All rights reserved.

# This handler is run whenever someone wants to expire old entries through the GUI
