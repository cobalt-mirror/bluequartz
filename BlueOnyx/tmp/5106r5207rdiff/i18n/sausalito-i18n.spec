...
%changelog
* Sun Apr 01 2012 Michael Stauber <mstauber@solarspeed.net> 0.70.2-86BX28
- Fix to php/I18n.php as fallback language was still defined as 'en', while it must be 'en_US' now.
