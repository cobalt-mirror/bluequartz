...
class StupidPass
{
  ...
  private $dict = '/usr/sausalito/ui/chorizo/ci/application/libraries/stupid-pass/StupidPass.default.dict';   // Path to the dictionary
  ...
  public function __construct($maxlen = 40, $environ = array(), $dict = null, $lang = null)
  {
    ...
    $this->dict = (isset($dict)) ? $dict: '/usr/sausalito/ui/chorizo/ci/application/libraries/stupid-pass/StupidPass.default.dict';
