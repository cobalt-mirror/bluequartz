...
<TABLE BORDER="0" CELLPADDING="0" CELLSPACING="0" WIDTH="80%">
  <TR>
	...
	if(!cssEnabled) {
	  ...
	  <!-- locale-sensitive -->
	  document.write("<BIG>&iexcl;Bienvenido y gracias por comprar el Sun Cobalt Qube 550! En unos minutos, su empresa dispondr&aacute; de servicios de correo electr&oacute;nico, web y uso compartido de archivos, adem&aacute;s de otros servicios.</BIG>");
