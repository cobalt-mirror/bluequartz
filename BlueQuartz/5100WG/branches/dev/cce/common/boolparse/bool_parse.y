/* $Id: bool_parse.y 229 2003-07-18 20:22:20Z will $ */
...
static void boolerror(char *);
static struct bool_node *bool_node_alloc(void);
extern int boollex(void);
...
boolerror(char *s)
{
//FIXME: we really should do something on error!
//FIXME: what happens to allocated memory on an error?
}
