...
%changelog
* Fri Jul 25 2003 Hisao SHIBUYA <shibuya@alpha.or.jp>
- (0.5.0-60OQ2)
- fix libPhp/uifc/Bar.php.

* Tue Jul 22 2003 Hisao SHIBUYA <shibuya@alpha.or.jp>
- (0.5.0-60OQ1)
- delete last blank line on PHP files.
- fix duplicate message problem in en locale.
- change encoding to euc-jp.
- fix loginHandler.php problem with Safari.
