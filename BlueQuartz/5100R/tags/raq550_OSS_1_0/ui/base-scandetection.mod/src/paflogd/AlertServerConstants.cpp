...
$header$
                ...
                Module :  $Source: /home/cvs/base-scandetection.mod/src/paflogd/AlertServerConstants.cpp,v $
...
const string AlertServer::SET_ALERT = "set AlertSettings";
const string AlertServer::GET_ALERT = "get AlertSettings";
