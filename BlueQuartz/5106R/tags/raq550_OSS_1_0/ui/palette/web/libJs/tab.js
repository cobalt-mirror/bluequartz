...
// $Id: tab.js 259 2004-01-03 06:28:40Z shibuya $
...
//    var topCell = (imageTop != "") ? "<TD STYLE=\"background-image:url("+imageTop+");\"><IMG SRC=\"/libImage/spaceHolder.gif\" WIDTH=\"1\" HEIGHT=\"1\"></TD>\n" : "";
//    var bottomCell = (imageBottom != "") ? "<TD STYLE=\"background-image:url("+imageBottom+");\"><IMG SRC=\"/libImage/spaceHolder.gif\" WIDTH=\"1\" HEIGHT=\"1\"></TD>\n" : "";
    var centerCell = "<TD NOWRAP STYLE=\""+style+"\" VALIGN=\"MIDDLE\">"+aTagStart+"<IMG BORDER=\"0\" SRC=\"/libImage/spaceHolder.gif\" WIDTH=\"5\" HEIGHT=\"5\">"+top.code.string_htmlEscape(item.getName())+"<IMG BORDER=\"0\" SRC=\"/libImage/spaceHolder.gif\" WIDTH=\"5\" HEIGHT=\"5\"></A></TD>\n";
    ...
    // if with top piece
//    else if(topCell != "")
//      doc.write("<TR>"+leftCell+topCell+rightCell+"</TR><TR>"+centerCell+"</TR><TR>"+bottomCell+"</TR>");
//    else
//      doc.write("<TR>"+leftCell+centerCell+rightCell+"</TR><TR>"+bottomCell+"</TR>");
  ...
  for(var i = 0; i< typedItems.length; i++) {
    ...
    doc.write("<TD NOWRAP VALIGN=\"TOP\"><A HREF=\""+item.getUrl()+"\" onMouseOver=\"return top.code.info_mouseOver('"+description+"')\" onMouseOut=\"return top.code.info_mouseOut();\"><IMG NAME=\""+type+"\" ALT=\""+top.code.string_htmlEscape(item.getName())+"\" BORDER=\"0\" SRC=\""+icon+"\"></A></TD>\n");
  }
