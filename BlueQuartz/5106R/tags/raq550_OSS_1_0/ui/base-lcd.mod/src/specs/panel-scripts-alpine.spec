...
%changelog
* Tue Apr 09 2002 Joshua Uziel <uzi@sun.com>
- fix "LOCK"/"UNLOCK" PANEL display on lcd

* Wed Mar 13 2002 Patrick Baltz <patrick.baltz@sun.com>
- add string entries to some menu items for localization

* Tue Mar  5 2002 Patrick Baltz <patrick.baltz@sun.com>
- add Japanese locale entry to lcd menu
